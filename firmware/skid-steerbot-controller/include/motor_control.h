...
// Pin definitions for motor control for arduino

// const int motorFL1 = 6;       // Front-left motor positive
// const int motorFL2 = 7;        // Front-left motor negative


// const int motorBL1 = 4;       // Back-left motor positive
// const int motorBL2 = 5;       // Back-left motor negative



// const int motorBR1 = 8;       // Back-right motor positive
// const int motorBR2 = 11;       // Back-right motor negative


// const int motorFR1 = 12;       // Front-right motor positive
// const int motorFR2 = 13;       // Front-right motor negative



// Pin definitions for motor control for esp32
